...
export function PoolPeriodSchedule() {
  ...
  return <main className="pool-page pool-period-schedule-page">
    ...
    <SelectedPeriodStatusCard period={selected} editable={editable} onManage={() => navigate(`/app/pool-kpis/manage-kpis?poolId=${poolId}&period=${encodeURIComponent(selected.start)}`)}/>
