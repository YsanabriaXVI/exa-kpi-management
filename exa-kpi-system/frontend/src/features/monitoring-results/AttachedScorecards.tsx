...
export function AttachedScorecards() {
  ...
  return <main className="monitor-page attached-scorecards-page">
    ...
    : <section className="attached-section"><header><div><h2>{query.data?.period.code}</h2><p>{query.data?.period.periodLabel} · {query.data?.period.status}</p></div></header>
