...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/api/v1/internal/kpi-configurations/effective-snapshots": { post: { tags: ["Internal"], summary: "Resolve effective KPI Configuration snapshots for an exact Input Period", description: "Returns exactly one revision per Configuration that covers periodStart through periodEnd. Missing coverage and overlapping revisions fail; latest revision is never used as fallback.", responses: { "200": { description: "Period-effective configuration snapshots" }, "400": { description: "Invalid request" }, "409": { description: "Missing or overlapping effective revision" }, "422": { description: "Unknown configuration" } } } },
