export const openApiDocument = {
  ...
  paths: {
    ...
    "/api/v1/kpi-pools/{id}/extend-validity": { post: { summary: "Extend an ACTIVE Pool validity without changing its start or existing Input Periods", responses: { "200": { description: "Pool validity extended" }, "409": { description: "Pool lifecycle does not allow extension" }, "422": { description: "End date does not extend or align with frequency" } } } },
