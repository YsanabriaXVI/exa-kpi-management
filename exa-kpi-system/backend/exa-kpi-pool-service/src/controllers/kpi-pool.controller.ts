...
import { addKpiPoolConfigurationsBodySchema, availableKpiConfigurationsQuerySchema, createKpiPoolBodySchema, extendKpiPoolValidityBodySchema, finalizePeriodCompositionBodySchema, kpiConfigurationUsageBodySchema, kpiPoolConfigurationParamsSchema, kpiPoolIdParamsSchema, listKpiPoolsQuerySchema, poolAssignmentEligibilityBodySchema, replaceKpiPoolConfigurationBodySchema, retireKpiPoolConfigurationBodySchema, targetPeriodQuerySchema, updateKpiPoolBodySchema } from "../schemas/kpi-pool.schema.js";
